...
#define NVIC_PRIO_ADC                      NVIC_BUILD_PRIORITY(2, 2)
...
#define NVIC_PRIO_SERIALUART11_TXDMA       NVIC_BUILD_PRIORITY(1, 0)
#define NVIC_PRIO_SERIALUART11_RXDMA       NVIC_BUILD_PRIORITY(1, 1)
#define NVIC_PRIO_SERIALUART11             NVIC_BUILD_PRIORITY(1, 2)
#define NVIC_PRIO_SERIALUART12_TXDMA       NVIC_BUILD_PRIORITY(1, 0)
#define NVIC_PRIO_SERIALUART12_RXDMA       NVIC_BUILD_PRIORITY(1, 1)
#define NVIC_PRIO_SERIALUART12             NVIC_BUILD_PRIORITY(1, 2)
#define NVIC_PRIO_SERIALUART13_TXDMA       NVIC_BUILD_PRIORITY(1, 0)
#define NVIC_PRIO_SERIALUART13_RXDMA       NVIC_BUILD_PRIORITY(1, 1)
#define NVIC_PRIO_SERIALUART13             NVIC_BUILD_PRIORITY(1, 2)
#define NVIC_PRIO_SERIALUART14_TXDMA       NVIC_BUILD_PRIORITY(1, 0)
#define NVIC_PRIO_SERIALUART14_RXDMA       NVIC_BUILD_PRIORITY(1, 1)
#define NVIC_PRIO_SERIALUART14             NVIC_BUILD_PRIORITY(1, 2)
#define NVIC_PRIO_SERIALUART15_TXDMA       NVIC_BUILD_PRIORITY(1, 0)
#define NVIC_PRIO_SERIALUART15_RXDMA       NVIC_BUILD_PRIORITY(1, 1)
#define NVIC_PRIO_SERIALUART15             NVIC_BUILD_PRIORITY(1, 2)
