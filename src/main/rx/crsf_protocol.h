...
enum {
    ...
    CRSF_FRAME_GPS_TIME_PAYLOAD_SIZE = 9,
    CRSF_FRAME_GPS_EXTENDED_PAYLOAD_SIZE = 20,
    CRSF_FRAME_VARIO_SENSOR_PAYLOAD_SIZE = 2,
    CRSF_FRAME_BATTERY_SENSOR_PAYLOAD_SIZE = 8,
    CRSF_FRAME_CELLS_PAYLOAD_SIZE = 3,  // source_id (1) + voltage uint16 (2)
    ...
    CRSF_FRAME_BARO_PAYLOAD_SIZE = 8,
    CRSF_FRAME_MAG_PAYLOAD_SIZE = 6,
    CRSF_FRAME_ACCGYRO_PAYLOAD_SIZE = 18,
};
